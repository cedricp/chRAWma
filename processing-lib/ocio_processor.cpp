...
OCIO_processor::OCIO_processor(std::string colorspace_in, std::string colorspace_out)
{
	_imp = new ocio_impl;
...
std::vector<std::string> OCIO_processor::get_displays()
{
...
void OCIO_processor::process(const Texture2D& tex, float* pre_color_matrix)
{
